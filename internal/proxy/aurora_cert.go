...
// The TrinityCore Aurora development chain is intentionally public and is
// embedded by the existing legacy proxy/HermesProxy implementations. It is not a
// private identity and must only be used for the local compatibility endpoint.
const auroraPrivateKeyPEM = `-----BEGIN RSA PRIVATE KEY-----
...
const auroraCertificateChainPEM = `-----BEGIN CERTIFICATE-----
